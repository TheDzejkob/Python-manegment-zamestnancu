...
#poznamky pro alexe
# funkce add item vezme inputy z vsek Entry componentu a vlozi je do list boxu
# funkce remove item vezme oznaceny item z list boxu a smaze ho
# ale to bys mohl pochopit i sam :D
